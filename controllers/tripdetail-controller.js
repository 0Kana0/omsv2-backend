...
exports.tripdetail_post = async (req, res, next) => {
  try {
    ...
    const { date, numberoftrip, totalDistance, remark, plateNumber, driverOne, driverTwo, customerId, typeId, teamId, networkId, servicetypeId, createBy, updateBy } = req.body
...
exports.tripdetail_put = async (req, res, next) => {
  try {
    ...
    const { createBy, updateBy, plateNumber, date, numberoftrip, totalDistance, remark, driverOne, driverTwo, customerId, typeId, teamId, networkId, servicetypeId } = req.body
